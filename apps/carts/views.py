...
#         items_prod_ids.append(item.id)
#
#     if prod_id in items_prod_ids:
#         cart.items.remove(target_product)
#         cart.total_items_price -= target_product.price * amount
...
#         return Response(
#             {
#                 "massage": f"product with ID  {prod_id} removed from cart",
#                 "cart": CartSerializer(cart).data,
#                 "prod": ProductSerializer(target_product).data,
#             },
#             status=status.HTTP_200_OK,
#         )
#     else:
#         return Response(
#             {
#                 "massage": f"product with ID  {prod_id} not exist",
#                 "cart": CartSerializer(cart).data,
#                 "prod": ProductSerializer(target_product).data,
#             },
#             status=status.HTTP_400_BAD_REQUEST,
